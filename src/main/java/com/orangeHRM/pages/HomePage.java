...
//    @FindBy(xpath = "//div[@class='oxd-toast-close-container']")
//    WebElement toastMessage;
    ...
    public boolean checkIfDashBordIsDisplayedAsHeader() {
        return checkIfElementIsDisplayed(dashBordAsHeader);
    }
    public void switchAndAcceptChangePasswordAlert(WebDriver driver) {
         switchToAlertAndAcceptIt(driver);
    }
    public void selectChangePasswordFromUserDropDown() throws Exception {
       selectAnOptionFromDropDown(userDropDown,"Change Password" );
    }
    ...
    public void updatePassword(String currentPassword,String updatedPassword) {
        ...
        LOG.info("Successfully landed in the Update Password page");
        typeText(currentPasswordField,currentPassword);
        typeText(PasswordField,updatedPassword);
        typeText(confirmationPasswordField,updatedPassword);
